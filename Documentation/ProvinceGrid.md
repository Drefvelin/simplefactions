...
> **Implementation status:** Step 54 (local O(1) province lookup; replaces HTTP for in-game spatial queries).
...
Grid script: [02-ps-province-grid](../../ProvinceSystem/Planning/batches/step-54/02-ps-province-grid.md)

Installations (uses grid for construct + port checks): [Installations.md](./Installations.md)
